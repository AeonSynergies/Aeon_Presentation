...
export const meridianPropertyDeck: DeckConfig = {
  ...
  staticContent: {
    ...
    about: {
      ...
      body: "Meridian Property Partners is a dedicated back-office team built specifically for **residential and commercial property owners and operators**. We're not a call center that happens to answer property questions — our team specializes in __leasing, maintenance coordination, and property financials__, and stays with your portfolio as it grows.",
      bullets: [
    ...
    challenges: {
      items: [
        ...
        { title: "Fragmented Data", description: "Spreadsheets and sticky notes instead of one clear operational picture" },
        { title: "Compliance Gaps", description: "Compliance and documentation gaps that surface at the worst time" },
        { title: "Vendor Oversight", description: "No time to properly vet new vendors or negotiate better rates" },
      ],
    },
    benefits: {
      items: [
        ...
        { title: "Consistent Owner Reporting", description: "Consistent, on-time owner reporting every month" },
        { title: "One Escalation Path", description: "A single escalation path for both tenants and owners" },
