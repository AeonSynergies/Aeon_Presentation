...
export const fedexPdDeck: DeckConfig = {
  ...
  staticContent: {
    ...
    about: {
      ...
      body: "Aeon Synergies is a dedicated back-office team built specifically for FedEx Pickup & Delivery contractors — purpose-built to support settlement reconciliation, driver payroll, and expense management. One team, embedded in your daily operations, not a rotating cast of vendors.",
      bullets: [
    ...
    challenges: {
      items: [
        ...
        "No clear picture of which routes are actually profitable",
        "Manual spreadsheets instead of one source of financial truth",
        "Owners buried in back-office work instead of growing the business",
      ],
    },
    benefits: {
      items: [
        "A dedicated expert team handling your settlements, payroll, and expenses — not a rotating help desk",
        "Clearer weekly and monthly financial visibility across every FedEx settlement",
        "Help understanding true route and business profitability, not just top-line revenue",
        "Clean, organized reporting that supports real decision-making",
        "Recovered revenue through rigorous settlement and expense reconciliation",
        "Reduced payroll errors and stronger driver trust through accurate, on-time pay",
